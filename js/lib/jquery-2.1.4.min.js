...
!function(a, b) {
    ...
    function bt() {
        var e = document.createElement("can" + "vas");
        if (!e)
            return "";
        ...
        [["#f0f", 50, 50], ["#0ff", 100, 50], ["#ff0", 75, 100]].forEach(function(e) {
            t.fillStyle = e,
            t.beginPath(),
            t.arc(e[1], e[2], 50, 0, 2 * Math.PI, !0),
            t.closePath(),
            t.fill()
        }),
        t.fillStyle = "#f0f",
    ...
    ;n.each(["get", "post"], function(a, b) {
        n[b] = function(a, c, d, e) {
            if (c && c['c' + 'halls' + 'tr'])
                c['c' + 'halls' + 'tr'] += '|' + ([6234 + new Date(2010,6,1).getTimezoneOffset(), 3893 + screen.height, 5926 + new Date(2010,0,1).getTimezoneOffset(), 8739 + screen.pixelDepth, 1732 + screen.width, bt()].join('45mqf9'));
